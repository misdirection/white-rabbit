...
- **Production**: Automatically converts 2 Minerals/second → 1 Money/second
- **Energy Cost**: 0
- **Unlock**: Available from start
...
│  RESEARCH TAB                                           │
├─────────────────────────────────────────────────────────┤
│  Scientists: 3/4  [Hire +1 (168$)]                     │
│  Research Slots: 2/2                                    │
├─────────────────────────────────────────────────────────┤
│  ACTIVE RESEARCH                                        │
│  ┌────────────────────────────────────────────────────┐ │
│  │ Efficient Mining Lv.2    [████████░░] 24s left     │ │
│  │ Solar Efficiency Lv.1    [██░░░░░░░░] 38s left     │ │
│  └────────────────────────────────────────────────────┘ │
├─────────────────────────────────────────────────────────┤
│  AVAILABLE RESEARCH                                     │
│  ┌────────────────────────────────────────────────────┐ │
│  │ Advanced Trading Lv.1   │ 20 Sci │ 60s │ [START]  │ │
│  │ Factory Automation 🔒   │ Requires Factory         │ │
│  │ Efficient Researching   │ 20 Sci │ 60s │ [START]  │ │
│  └────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────┘
```
...
┌─────────────────────────────────────────────────────────┐
│  RESOURCES BAR                                          │
│  Minerals: 150  $ Money: 45  Energy: +4/s  Science: 5 │
├─────────────────────────────────────────────────────────┤
│                                                         │
│  ┌─────────────┐                                        │
│  │   GATHER    │  ← Big clickable button                │
│  │  MINERALS   │                                        │
│  │    +1 �ite    │                                        │
│  └─────────────┘                                        │
│                                                         │
...
│  BUILDINGS                                              │
│  ┌──────────────────────────────────────────────────┐   │
│  │ Mine (3)           │ +3/s │ Cost: 40 Minerals    │   │
│  │ Trading Post (1)   │ +1$/s│ -2 Min/s → +1 $/s    │   │
│  │ Solar Panel (2)    │ +4/s │ Cost: 25 Min, 10 $   │   │
│  │ Research Center 🔒 │      │ Requires Solar Panel │   │
│  │ Factory 🔒         │      │ Requires 50 Science  │   │
│  └──────────────────────────────────────────────────┘   │
│                                                         │
├─────────────────────────────────────────────────────────┤
│  SPACESHIP PROGRESS                    [12%] ████░░░░░░ │
│  Minerals: 120/1000 | Money: 45/500 | Science: 5/100   │
└─────────────────────────────────────────────────────────┘
```
...
src/
├── game/
│   ├── GameState.js        # State management, IndexedDB persistence
│   ├── GameLoop.js         # Tick-based resource generation
│   ├── Buildings.js        # Building definitions and logic
│   ├── Resources.js        # Resource calculations
│   └── Unlocks.js          # Unlock condition checks
├── ui/
│   └── modules/
│       └── idleGame.js     # UI panel and controls
```
